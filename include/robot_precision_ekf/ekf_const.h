...
#define PRIOR_COV_IMUBIAS pow(0.5,2)
...
#define MU_SYSTEM_NOISE_IMUBIAS 0.0
...
// GPS Measurement
#define GPS_LEVERARM_X 0.0 // -0.45 // TODO: Pull the leverarm from the base_link->base_gps transform
