...
#ifndef __NON_LINEAR_SYSTEM_CONDITIONAL_GAUSSIAN_ROBOT_VERR__
#define __NON_LINEAR_SYSTEM_CONDITIONAL_GAUSSIAN_ROBOT_VERR__
...
namespace BFL
{
  ...
  */
  class NonLinearAnalyticConditionalGaussianRobotVerr : public AnalyticConditionalGaussianAdditiveNoise
  {
    public:
      /// Constructor
      ...
      */
      NonLinearAnalyticConditionalGaussianRobotVerr( const Gaussian& additiveNoise, double timestep);
