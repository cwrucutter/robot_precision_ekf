...
#include <robot_precision_ekf/nonlinearanalyticconditionalgaussian_robot_verr.h>
...
namespace BFL
{
  ...
  NonLinearAnalyticConditionalGaussianRobotVerr::NonLinearAnalyticConditionalGaussianRobotVerr(const Gaussian& additiveNoise, double timestep)
  ...
  NonLinearAnalyticConditionalGaussianRobotVerr::~NonLinearAnalyticConditionalGaussianRobotVerr(){}

  void NonLinearAnalyticConditionalGaussianRobotVerr::setTimestep(double timestep)
  {
    dt = timestep;
  }
  
  ColumnVector NonLinearAnalyticConditionalGaussianRobotVerr::ExpectedValueGet() const
  {
    double v,w,tht_mid;
    ColumnVector state;
  ...
  Matrix NonLinearAnalyticConditionalGaussianRobotVerr::dfGet(unsigned int i) const
  {
    double v,w,tht_mid;
